package com.cs.microservices.price.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("jhipsterPriceCheck");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("jhipsterPriceCheck");
        ...
        config.getMapConfigs().put("com.cs.microservices.price.domain.*", initializeDomainMapConfig(jHipsterProperties));
